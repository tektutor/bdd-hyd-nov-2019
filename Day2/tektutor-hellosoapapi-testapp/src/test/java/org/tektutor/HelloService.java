 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://tektutor.org", wsdlLocation = "http://localhost:8080/Hello/services/Hello?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/Hello/services/Hello?wsdl");
